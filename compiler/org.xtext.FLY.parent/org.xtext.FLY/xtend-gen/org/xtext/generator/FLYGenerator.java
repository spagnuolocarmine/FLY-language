...
public class FLYGenerator extends AbstractGenerator {
  ...
  public String generateEnvironmentDeclaration(final EnvironmentDeclaration dec) {
    ...
    if (_equals) {
      ...
      if (_equals_1) {
        ...
        _builder_1.newLineIfNotEmpty();
        _builder_1.newLine();
        _builder_1.append("static AmazonSQS __sqs_");
        String _name_2 = dec.getName();
        _builder_1.append(_name_2);
        _builder_1.append("  = AmazonSQSClient.builder()");
        _builder_1.newLineIfNotEmpty();
        _builder_1.append("\t");
        ...
        _builder_1.newLine();
        _builder_1.newLine();
        _builder_1.append("static AmazonIdentityManagement __iam_");
        String _name_4 = dec.getName();
        _builder_1.append(_name_4);
        _builder_1.append(" = AmazonIdentityManagementClientBuilder.standard()");
        _builder_1.newLineIfNotEmpty();
        _builder_1.append("\t");
        _builder_1.append(".withCredentials(new AWSStaticCredentialsProvider(");
        String _name_5 = dec.getName();
        ...
        _builder_1.append("\t");
        _builder_1.newLine();
        _builder_1.append("static AWSLambda __lambda_");
        String _name_6 = dec.getName();
        _builder_1.append(_name_6);
        _builder_1.append(" = AWSLambdaClientBuilder.standard()");
        _builder_1.newLineIfNotEmpty();
        _builder_1.append("\t");
        _builder_1.append(".withCredentials(new AWSStaticCredentialsProvider(");
        String _name_7 = dec.getName();
        ...
        _builder_1.append("\t");
        _builder_1.newLine();
        _builder_1.append("static AmazonS3 __s3_");
        String _name_8 = dec.getName();
        _builder_1.append(_name_8);
        _builder_1.append(" = AmazonS3Client.builder()");
        _builder_1.newLineIfNotEmpty();
        _builder_1.append("\t");
        _builder_1.append(".withCredentials(new AWSStaticCredentialsProvider(");
        String _name_9 = dec.getName();
  ...
  public String generateChanelDeclarationForCloud(final ChannelDeclaration declaration) {
    ...
    if (_equals) {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("__sqs_");
      String _name = declaration.getEnvironment().getName();
      _builder.append(_name);
      _builder.append(".createQueue(new CreateQueueRequest(\"");
      String _name_1 = declaration.getName();
      _builder.append(_name_1);
                              ...
                              if (_equals_5) {
                                ...
                                if ((_target instanceof ChannelReceive)) {
                                  ...
                                  if (_equals_6) {
                                    ...
                                    EnvironmentDeclaration _environment_1 = ((ChannelReceive) _target_2).getTarget().getEnvironment();
                                    String env_name = ((EnvironmentDeclaration) _environment_1).getName();
                                    boolean _equals_7 = ((CastExpression)expression).getType().equals("Integer");
                                    if (_equals_7) {
                                      StringConcatenation _builder_23 = new StringConcatenation();
                                      _builder_23.append("__");
                                      _builder_23.newLine();
                                      _builder_23.append("ReceiveMessageRequest __recmsg = new ReceiveMessageRequest(__sqs_");
                                      _builder_23.append(env_name);
                                      _builder_23.append(".getQueueUrl(\"");
                                      ArithmeticExpression _target_3 = ((CastExpression)expression).getTarget();
                                      String _name_16 = ((ChannelReceive) _target_3).getTarget().getName();
                                      _builder_23.append(_name_16);
                                      _builder_23.append("\"+__id_execution).getQueueUrl());");
                                      _builder_23.newLineIfNotEmpty();
                                      _builder_23.append("ReceiveMessageResult __res = __sqs_");
                                      _builder_23.append(env_name);
                                      _builder_23.append(".receiveMessage(__recmsg);");
                                      _builder_23.newLineIfNotEmpty();
                                      _builder_23.append("while(__res.getMessages().size() == 0){");
                                      _builder_23.newLine();
                                      _builder_23.append("\t");
                                      _builder_23.append("__res = __sqs_");
                                      _builder_23.append(env_name, "\t");
                                      _builder_23.append(".receiveMessage(__recmsg);");
                                      _builder_23.newLineIfNotEmpty();
                                      _builder_23.append("}");
                                      ...
                                      _builder_23.newLine();
                                      _builder_23.append("__sqs_");
                                      _builder_23.append(env_name);
                                      _builder_23.append(".deleteMessage(__sqs_");
                                      _builder_23.append(env_name);
                                      _builder_23.append(".getQueueUrl(\"");
                                      ArithmeticExpression _target_4 = ((CastExpression)expression).getTarget();
                                      String _name_17 = ((ChannelReceive) _target_4).getTarget().getName();
                                      ...
                                      if (_equals_8) {
                                        ...
                                        _builder_24.append("ReceiveMessageRequest __recmsg = new ReceiveMessageRequest(__sqs_");
                                        _builder_24.append(env_name);
                                        _builder_24.append(".getQueueUrl(\"");
                                        ArithmeticExpression _target_5 = ((CastExpression)expression).getTarget();
                                        String _name_18 = ((ChannelReceive) _target_5).getTarget().getName();
                                        _builder_24.append(_name_18);
                                        _builder_24.append("\"+__id_execution).getQueueUrl());");
                                        _builder_24.newLineIfNotEmpty();
                                        _builder_24.append("ReceiveMessageResult __res = __sqs_");
                                        _builder_24.append(env_name);
                                        _builder_24.append(".receiveMessage(__recmsg);");
                                        _builder_24.newLineIfNotEmpty();
                                        _builder_24.append("while(__res.getMessages().size() == 0){");
                                        _builder_24.newLine();
                                        _builder_24.append("__res = __sqs_");
                                        _builder_24.append(env_name);
                                        _builder_24.append(".receiveMessage(__recmsg);");
                                        _builder_24.newLineIfNotEmpty();
                                        _builder_24.append("}");
                                        ...
                                        _builder_24.newLine();
                                        _builder_24.append("__sqs_");
                                        _builder_24.append(env_name);
                                        _builder_24.append(".deleteMessage(__sqs_");
                                        _builder_24.append(env_name);
                                        _builder_24.append(".getQueueUrl(\"");
                                        ArithmeticExpression _target_6 = ((CastExpression)expression).getTarget();
                                        String _name_19 = ((ChannelReceive) _target_6).getTarget().getName();
  ...
  public String generateAWSFlyFunctionCall(final FlyFunctionCall call, final String scope) {
    ...
    if (_isIs_for_index) {
      if ((!async)) {
        String _ret = ret;
        StringConcatenation _builder_1 = new StringConcatenation();
        _builder_1.append("__sqs_");
        _builder_1.append(cred);
        _builder_1.append(".createQueue(new CreateQueueRequest(\"__syncTermination_");
        String _name = call.getTarget().getName();
        _builder_1.append(_name);
      ...
      if ((_f_index instanceof RangeLiteral)) {
        ...
        _builder_2.newLineIfNotEmpty();
        _builder_2.append("\t");
        _builder_2.append("final String __s_temp = String.valueOf(___i);");
        _builder_2.newLine();
        _builder_2.append("\t");
        ...
        _builder_2.newLine();
        _builder_2.append("\t\t\t");
        _builder_2.append("__lambda_");
        _builder_2.append(cred, "\t\t\t");
        _builder_2.append(".invoke(new InvokeRequest()");
        _builder_2.newLineIfNotEmpty();
        _builder_2.append("\t\t\t\t");
        ...
        if (((call.getInput().getF_index() instanceof VariableLiteral) && 
          ...
          String _name_6 = ((VariableLiteral) _f_index_5).getVariable().getName();
          ...
          _builder_3.append("_");
          _builder_3.append(this.func_ID);
          _builder_3.append(" = (int) __fly_environment.get(\"");
          _builder_3.append(cred);
          _builder_3.append("\").get(\"nthread\");");
          _builder_3.newLineIfNotEmpty();
          ...
          _builder_3.newLineIfNotEmpty();
          _builder_3.append("for(int __i=0;__i<__num_proc;__i++) {");
          _builder_3.newLine();
          _builder_3.append("\t");
          ...
          String _name_29 = ((VariableLiteral) _f_index_6).getVariable().getName();
          _builder_3.append(_name_29, "\t\t\t");
          _builder_3.append(".where(Selection.withRange(__start, __end)));");
          _builder_3.newLineIfNotEmpty();
          _builder_3.append("\t\t\t");
          _builder_3.append("__lambda_");
          _builder_3.append(cred, "\t\t\t");
          _builder_3.append(".invoke(new InvokeRequest()");
          _builder_3.newLineIfNotEmpty();
          _builder_3.append("\t\t\t\t");
          ...
          if (((call.getInput().getF_index() instanceof VariableLiteral) && 
            ...
            String _name_33 = ((VariableLiteral) _f_index_7).getVariable().getName();
            ...
            String _name_34 = ((VariableLiteral) _f_index_8).getVariable().getName();
            ...
            String _name_35 = ((VariableLiteral) _f_index_9).getVariable().getName();
            _builder_4.append(_name_35);
            _builder_4.append("_");
            _builder_4.append(this.func_ID);
            _builder_4.append(" = new Scanner(");
            ArithmeticExpression _f_index_10 = call.getInput().getF_index();
            String _name_36 = ((VariableLiteral) _f_index_10).getVariable().getName();
            _builder_4.append(_name_36);
            _builder_4.append(");");
            _builder_4.newLineIfNotEmpty();
            _builder_4.append("while(__scanner_");
            ArithmeticExpression _f_index_11 = call.getInput().getF_index();
            String _name_37 = ((VariableLiteral) _f_index_11).getVariable().getName();
            ...
            ArithmeticExpression _f_index_12 = call.getInput().getF_index();
            String _name_38 = ((VariableLiteral) _f_index_12).getVariable().getName();
            ...
            ArithmeticExpression _f_index_13 = call.getInput().getF_index();
            String _name_39 = ((VariableLiteral) _f_index_13).getVariable().getName();
            _builder_4.append(_name_39, "\t\t");
            _builder_4.append("_");
            _builder_4.append(this.func_ID, "\t\t");
            _builder_4.append(".get(__temp_i_");
            ArithmeticExpression _f_index_14 = call.getInput().getF_index();
            String _name_40 = ((VariableLiteral) _f_index_14).getVariable().getName();
            ...
            _builder_4.append("__temp_");
            ArithmeticExpression _f_index_15 = call.getInput().getF_index();
            String _name_42 = ((VariableLiteral) _f_index_15).getVariable().getName();
            _builder_4.append(_name_42, "\t\t");
            _builder_4.append("_");
            _builder_4.append(this.func_ID, "\t\t");
            _builder_4.append(".get(__temp_i_");
            ArithmeticExpression _f_index_16 = call.getInput().getF_index();
            String _name_43 = ((VariableLiteral) _f_index_16).getVariable().getName();
            _builder_4.append(_name_43, "\t\t");
            _builder_4.append("_");
            _builder_4.append(this.func_ID, "\t\t");
            _builder_4.append(" % __num_proc_");
            String _name_44 = call.getTarget().getName();
            ...
            _builder_4.append("__temp_");
            ArithmeticExpression _f_index_17 = call.getInput().getF_index();
            String _name_45 = ((VariableLiteral) _f_index_17).getVariable().getName();
            _builder_4.append(_name_45, "\t\t");
            _builder_4.append("_");
            _builder_4.append(this.func_ID, "\t\t");
            _builder_4.append(".add(__temp_i_");
            ArithmeticExpression _f_index_18 = call.getInput().getF_index();
            String _name_46 = ((VariableLiteral) _f_index_18).getVariable().getName();
            _builder_4.append(_name_46, "\t\t");
            _builder_4.append("_");
            _builder_4.append(this.func_ID, "\t\t");
            _builder_4.append(" % __num_proc_");
            String _name_47 = call.getTarget().getName();
            ...
            _builder_4.append("__temp_");
            ArithmeticExpression _f_index_19 = call.getInput().getF_index();
            String _name_48 = ((VariableLiteral) _f_index_19).getVariable().getName();
            _builder_4.append(_name_48, "\t\t");
            _builder_4.append("_");
            _builder_4.append(this.func_ID, "\t\t");
            _builder_4.append(".get(__temp_i_");
            ArithmeticExpression _f_index_20 = call.getInput().getF_index();
            String _name_49 = ((VariableLiteral) _f_index_20).getVariable().getName();
            ...
            _builder_4.append("__temp_");
            ArithmeticExpression _f_index_21 = call.getInput().getF_index();
            String _name_51 = ((VariableLiteral) _f_index_21).getVariable().getName();
            _builder_4.append(_name_51, "\t\t");
            _builder_4.append("_");
            _builder_4.append(this.func_ID, "\t\t");
            _builder_4.append(".get(__temp_i_");
            ArithmeticExpression _f_index_22 = call.getInput().getF_index();
            String _name_52 = ((VariableLiteral) _f_index_22).getVariable().getName();
            ...
            ArithmeticExpression _f_index_23 = call.getInput().getF_index();
            String _name_54 = ((VariableLiteral) _f_index_23).getVariable().getName();
            ...
            ArithmeticExpression _f_index_24 = call.getInput().getF_index();
            String _name_55 = ((VariableLiteral) _f_index_24).getVariable().getName();
            ...
            String _name_57 = call.getEnvironment().getName();
            ...
            ArithmeticExpression _f_index_25 = call.getInput().getF_index();
            String _name_58 = ((VariableLiteral) _f_index_25).getVariable().getName();
            ...
            _builder_4.newLineIfNotEmpty();
            _builder_4.append("\t\t\t");
            _builder_4.append("__lambda_");
            _builder_4.append(cred, "\t\t\t");
            _builder_4.append(".invoke(new InvokeRequest()");
            _builder_4.newLineIfNotEmpty();
            _builder_4.append("\t\t\t\t");
    ...
    if ((!async)) {
      ...
      String _name_61 = call.getTarget().getName();
      _builder_5.append(_name_61);
      _builder_5.append("_");
      _builder_5.append(this.func_ID);
      _builder_5.append("){");
      _builder_5.newLineIfNotEmpty();
      ...
      String _name_62 = call.getTarget().getName();
      _builder_5.append(_name_62);
      _builder_5.append("_");
      _builder_5.append(this.func_ID);
      _builder_5.append(" = 0;");
      _builder_5.newLineIfNotEmpty();
      _builder_5.append("String __queue_url___syncTermination_");
      String _name_63 = call.getTarget().getName();
      _builder_5.append(_name_63);
      _builder_5.append("_");
      _builder_5.append(this.func_ID);
      _builder_5.append(" =\t__sqs_");
      _builder_5.append(cred);
      _builder_5.append(".getQueueUrl(\"__syncTermination_");
      String _name_64 = call.getTarget().getName();
      _builder_5.append(_name_64);
      _builder_5.append("_\"+__id_execution).getQueueUrl();");
      _builder_5.newLineIfNotEmpty();
      _builder_5.append("while(__messagges_");
      String _name_65 = call.getTarget().getName();
      _builder_5.append(_name_65);
      _builder_5.append("_");
      _builder_5.append(this.func_ID);
      _builder_5.append("!=__num_proc_");
      String _name_66 = call.getTarget().getName();
      _builder_5.append(_name_66);
      _builder_5.append("_");
      _builder_5.append(this.func_ID);
      _builder_5.append(") {");
      _builder_5.newLineIfNotEmpty();
      ...
      String _name_67 = call.getTarget().getName();
      _builder_5.append(_name_67, "\t");
      _builder_5.append("_");
      _builder_5.append(this.func_ID, "\t");
      _builder_5.append(").");
      _builder_5.newLineIfNotEmpty();
      ...
      _builder_5.append("__sqs_");
      _builder_5.append(cred, "\t\t");
      _builder_5.append(".deleteMessage(__queue_url___syncTermination_");
      String _name_69 = call.getTarget().getName();
      _builder_5.append(_name_69, "\t\t");
      _builder_5.append("_");
      _builder_5.append(this.func_ID, "\t\t");
      ...
      _builder_5.append("__sqs_");
      _builder_5.append(cred);
      _builder_5.append(".deleteQueue(new DeleteQueueRequest(__queue_url___syncTermination_");
      String _name_70 = call.getTarget().getName();
      _builder_5.append(_name_70);
      _builder_5.append("_");
      _builder_5.append(this.func_ID);
      _builder_5.append("));");
      _builder_5.newLineIfNotEmpty();
    ...
    if (_isIs_thenall) {
      String _ret_5 = ret;
      StringConcatenation _builder_6 = new StringConcatenation();
      String _name_71 = call.getThenall().getName();
  ...
  public String generateChannelSend(final ChannelSend send, final String scope) {
    ...
    DeclarationFeature _get = ((DeclarationObject) _right).getFeatures().get(0);
    String env = ((DeclarationFeature) _get).getValue_s();
    String env_name = send.getTarget().getEnvironment().getName();
    boolean _equals = env.equals("smp");
    if (_equals) {
      StringConcatenation _builder = new StringConcatenation();
      ...
      if (_equals_1) {
        StringConcatenation _builder_1 = new StringConcatenation();
        _builder_1.append("SendMessageRequest __sndmsg = new SendMessageRequest(__sqs_");
        _builder_1.append(env_name);
        ...
        _builder_1.append("__sqs_");
        _builder_1.append(env_name);
        _builder_1.append(".sendMessage(__sndmsg)");
        _builder_1.newLineIfNotEmpty();
        return _builder_1.toString();
      }
    }
  ...
  public String generateFunctionDefinition(final FunctionDefinition definition) {
    ...
    InputOutput.<String>println(definition.getName());
    StringConcatenation _builder = new StringConcatenation();
    _builder.newLine();
    _builder.append("\t");
  ...
  public String getParameterType(final String name, final Expression param, final int pos) {
    InputOutput.<String>println(((((("getParameterType " + name) + " params ") + param) + "pos ") + Integer.valueOf(pos)));
    ...
    for (final Expression exp : _filter) {
      if (((exp instanceof LocalFunctionCall) && Objects.equal(((LocalFunctionCall) exp).getTarget().getName(), name))) {
        ...
        InputOutput.<String>println(typeobject);
