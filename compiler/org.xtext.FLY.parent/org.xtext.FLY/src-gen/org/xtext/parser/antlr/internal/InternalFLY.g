...
@after {
	...
	(
		...
		{
			$current = $this_VariableFunction_14.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_PostfixOperation_15.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_RequireExpression_16.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_NativeExpression_17.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleForDelimeter returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getForDelimeterRule()); }
	iv_ruleForDelimeter=ruleForDelimeter
	{ $current=$iv_ruleForDelimeter.current; }
	EOF;

// Rule ForDelimeter
ruleForDelimeter returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_ArithmeticExpression_6.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleSubIndex returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSubIndexRule()); }
	iv_ruleSubIndex=ruleSubIndex
	{ $current=$iv_ruleSubIndex.current; }
	EOF;

// Rule SubIndex
ruleSubIndex returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleRequireExpression returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRequireExpressionRule()); }
	iv_ruleRequireExpression=ruleRequireExpression
	{ $current=$iv_ruleRequireExpression.current; }
	EOF;

// Rule RequireExpression
ruleRequireExpression returns [EObject current=null]
@init {
	enterRule();
}
@after {
