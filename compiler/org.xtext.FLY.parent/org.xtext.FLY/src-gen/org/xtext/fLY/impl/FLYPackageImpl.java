...
public class FLYPackageImpl extends EPackageImpl implements FLYPackage
{
   ...
   * @generated
   */
  private EClass forDelimeterEClass = null;
   ...
   * @generated
   */
  private EClass subIndexEClass = null;
   ...
   * @generated
   */
  private EClass requireExpressionEClass = null;
   ...
   * @generated
   */
  public EReference getForExpression_Delimeter()
  {
   ...
   * @generated
   */
  public EClass getForDelimeter()
  {
    return forDelimeterEClass;
  }
   ...
   * @generated
   */
  public EAttribute getForDelimeter_Type()
  {
    return (EAttribute)forDelimeterEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getForDelimeter_Del()
  {
    return (EAttribute)forDelimeterEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getForIndex_Indices()
  {
    return (EReference)forIndexEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EClass getSubIndex()
  {
    return subIndexEClass;
  }
   ...
   * @generated
   */
  public EReference getSubIndex_Value()
  {
    return (EReference)subIndexEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getSubIndex_Value2()
  {
    return (EReference)subIndexEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getRangeLiteral_Value_l1()
  {
    return (EReference)rangeLiteralEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getRangeLiteral_Value_l2()
  {
    return (EReference)rangeLiteralEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EAttribute getNativeExpression_Code()
  {
   ...
   * @generated
   */
  public EClass getRequireExpression()
  {
    return requireExpressionEClass;
  }
   ...
   * @generated
   */
  public EAttribute getRequireExpression_Lib()
  {
    return (EAttribute)requireExpressionEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getRequireExpression_Environment()
  {
    return (EReference)requireExpressionEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getPostfixOperation_Variable()
  {
   ...
   * @generated
   */
  public EAttribute getDatDeclaration_OnCloud()
  {
    return (EAttribute)datDeclarationEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getDatDeclaration_Environment()
  {
    return (EReference)datDeclarationEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EAttribute getArrayDefinition_Type()
  {
    return (EAttribute)arrayDefinitionEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getNameObject_Name()
  {
    return (EReference)nameObjectEClass.getEStructuralFeatures().get(0);
  }
  ...
  {
    return (EAttribute)nameObjectEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getIndexObject_Name()
  {
    return (EReference)indexObjectEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getIndexObject_Indexes()
  {
   ...
   * @generated
   */
  public EReference getDatSingleObject_Name()
  {
  ...
  {
    return (EReference)datSingleObjectEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getDatTableObject_Name()
  {
  ...
  {
    return (EReference)datTableObjectEClass.getEStructuralFeatures().get(3);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(forExpressionEClass, FOR_EXPRESSION__DELIMETER);
    createEReference(forExpressionEClass, FOR_EXPRESSION__BODY);

    forDelimeterEClass = createEClass(FOR_DELIMETER);
    createEAttribute(forDelimeterEClass, FOR_DELIMETER__TYPE);
    createEAttribute(forDelimeterEClass, FOR_DELIMETER__DEL);

    forIndexEClass = createEClass(FOR_INDEX);
    createEReference(forIndexEClass, FOR_INDEX__INDICES);
    ...
    subIndexEClass = createEClass(SUB_INDEX);
    createEReference(subIndexEClass, SUB_INDEX__VALUE);
    createEReference(subIndexEClass, SUB_INDEX__VALUE2);

    rangeLiteralEClass = createEClass(RANGE_LITERAL);
    createEAttribute(rangeLiteralEClass, RANGE_LITERAL__VALUE1);
    createEReference(rangeLiteralEClass, RANGE_LITERAL__VALUE_L1);
    createEAttribute(rangeLiteralEClass, RANGE_LITERAL__VALUE2);
    createEReference(rangeLiteralEClass, RANGE_LITERAL__VALUE_L2);
    ...
    createEAttribute(nativeExpressionEClass, NATIVE_EXPRESSION__CODE);

    requireExpressionEClass = createEClass(REQUIRE_EXPRESSION);
    createEAttribute(requireExpressionEClass, REQUIRE_EXPRESSION__LIB);
    createEReference(requireExpressionEClass, REQUIRE_EXPRESSION__ENVIRONMENT);

    postfixOperationEClass = createEClass(POSTFIX_OPERATION);
    createEReference(postfixOperationEClass, POSTFIX_OPERATION__VARIABLE);
    ...
    createEAttribute(datDeclarationEClass, DAT_DECLARATION__ON_CLOUD);
    createEReference(datDeclarationEClass, DAT_DECLARATION__ENVIRONMENT);
    ...
    createEAttribute(arrayDefinitionEClass, ARRAY_DEFINITION__TYPE);
    ...
    createEReference(nameObjectEClass, NAME_OBJECT__NAME);
    createEAttribute(nameObjectEClass, NAME_OBJECT__VALUE);

    indexObjectEClass = createEClass(INDEX_OBJECT);
    createEReference(indexObjectEClass, INDEX_OBJECT__NAME);
    createEReference(indexObjectEClass, INDEX_OBJECT__INDEXES);

    datSingleObjectEClass = createEClass(DAT_SINGLE_OBJECT);
    createEReference(datSingleObjectEClass, DAT_SINGLE_OBJECT__NAME);
    ...
    createEReference(datTableObjectEClass, DAT_TABLE_OBJECT__NAME);
  ...
  public void initializePackageContents()
  {
    ...
    objectEClass.getESuperTypes().add(this.getFeautureName());
    ...
    requireExpressionEClass.getESuperTypes().add(this.getExpression());
    postfixOperationEClass.getESuperTypes().add(this.getExpression());
    arithmeticExpressionEClass.getESuperTypes().add(this.getArrayValue());
    ...
    arrayDefinitionEClass.getESuperTypes().add(this.getObject());
    arrayInitEClass.getESuperTypes().add(this.getObject());
    ...
    initEReference(getForExpression_Index(), this.getForIndex(), null, "index", null, 0, 1, ForExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getForExpression_Delimeter(), this.getForDelimeter(), null, "delimeter", null, 0, 1, ForExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(forDelimeterEClass, ForDelimeter.class, "ForDelimeter", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getForDelimeter_Type(), ecorePackage.getEString(), "type", null, 0, 1, ForDelimeter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getForDelimeter_Del(), ecorePackage.getEString(), "del", null, 0, 1, ForDelimeter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(forIndexEClass, ForIndex.class, "ForIndex", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getForIndex_Indices(), this.getVariableFor(), null, "indices", null, 0, -1, ForIndex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getIndex_Value(), this.getArithmeticExpression(), null, "value", null, 0, 1, Index.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(arrayValueEClass, ArrayValue.class, "ArrayValue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getArrayValue_Values(), this.getArrayValue(), null, "values", null, 0, -1, ArrayValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(subIndexEClass, SubIndex.class, "SubIndex", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSubIndex_Value(), this.getArithmeticExpression(), null, "value", null, 0, 1, SubIndex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSubIndex_Value2(), this.getArithmeticExpression(), null, "value2", null, 0, 1, SubIndex.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRangeLiteral_Value_l1(), this.getVariableDeclaration(), null, "value_l1", null, 0, 1, RangeLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRangeLiteral_Value_l2(), this.getVariableDeclaration(), null, "value_l2", null, 0, 1, RangeLiteral.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getNativeExpression_Code(), ecorePackage.getEString(), "code", null, 0, 1, NativeExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(requireExpressionEClass, RequireExpression.class, "RequireExpression", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRequireExpression_Lib(), ecorePackage.getEString(), "lib", null, 0, 1, RequireExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRequireExpression_Environment(), this.getEnvironmentDeclaration(), null, "environment", null, 0, 1, RequireExpression.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getPostfixOperation_Variable(), this.getArithmeticExpression(), null, "variable", null, 0, 1, PostfixOperation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getDatDeclaration_OnCloud(), ecorePackage.getEBoolean(), "onCloud", null, 0, 1, DatDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDatDeclaration_Environment(), this.getEnvironmentDeclaration(), null, "environment", null, 0, 1, DatDeclaration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getArrayDefinition_Type(), ecorePackage.getEString(), "type", null, 0, 1, ArrayDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getArrayDefinition_Indexes(), this.getIndex(), null, "indexes", null, 0, -1, ArrayDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(arrayInitEClass, ArrayInit.class, "ArrayInit", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getArrayInit_Values(), this.getArrayValue(), null, "values", null, 0, -1, ArrayInit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(nameObjectEClass, NameObject.class, "NameObject", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getNameObject_Name(), this.getVariableDeclaration(), null, "name", null, 0, 1, NameObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getIndexObject_Name(), this.getVariableDeclaration(), null, "name", null, 0, 1, IndexObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getIndexObject_Indexes(), this.getSubIndex(), null, "indexes", null, 0, -1, IndexObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDatSingleObject_Name(), this.getDatDeclaration(), null, "name", null, 0, 1, DatSingleObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDatTableObject_Name(), this.getDatDeclaration(), null, "name", null, 0, 1, DatTableObject.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
