 ...
 *   <li>{@link org.xtext.fLY.impl.ForExpressionImpl#getDelimeter <em>Delimeter</em>}</li>
...
public class ForExpressionImpl extends ExpressionImpl implements ForExpression
{
  ...
  /**
   * The cached value of the '{@link #getDelimeter() <em>Delimeter</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getDelimeter()
   * @generated
   * @ordered
   */
  protected ForDelimeter delimeter;
   ...
   * @generated
   */
  public NotificationChain basicSetIndex(ForIndex newIndex, NotificationChain msgs)
  {
    ForIndex oldIndex = index;
    index = newIndex;
   ...
   * @generated
   */
  public void setIndex(ForIndex newIndex)
  {
    if (newIndex != index)
    {
   ...
   * @generated
   */
  public ForDelimeter getDelimeter()
  {
    return delimeter;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetDelimeter(ForDelimeter newDelimeter, NotificationChain msgs)
  {
    ForDelimeter oldDelimeter = delimeter;
    delimeter = newDelimeter;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FLYPackage.FOR_EXPRESSION__DELIMETER, oldDelimeter, newDelimeter);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   * @generated
   */
  public void setDelimeter(ForDelimeter newDelimeter)
  {
    if (newDelimeter != delimeter)
    {
      NotificationChain msgs = null;
      if (delimeter != null)
        msgs = ((InternalEObject)delimeter).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FLYPackage.FOR_EXPRESSION__DELIMETER, null, msgs);
      if (newDelimeter != null)
        msgs = ((InternalEObject)newDelimeter).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FLYPackage.FOR_EXPRESSION__DELIMETER, null, msgs);
      msgs = basicSetDelimeter(newDelimeter, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FLYPackage.FOR_EXPRESSION__DELIMETER, newDelimeter, newDelimeter));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case FLYPackage.FOR_EXPRESSION__DELIMETER:
        return basicSetDelimeter(null, msgs);
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case FLYPackage.FOR_EXPRESSION__INDEX:
        setIndex((ForIndex)newValue);
        return;
      case FLYPackage.FOR_EXPRESSION__OBJECT:
        setObject((ArithmeticExpression)newValue);
        return;
      case FLYPackage.FOR_EXPRESSION__DELIMETER:
        setDelimeter((ForDelimeter)newValue);
        return;
      case FLYPackage.FOR_EXPRESSION__BODY:
  ...
  public void eUnset(int featureID)
  {
    ...
    {
      case FLYPackage.FOR_EXPRESSION__INDEX:
        setIndex((ForIndex)null);
        return;
      case FLYPackage.FOR_EXPRESSION__OBJECT:
        setObject((ArithmeticExpression)null);
        return;
      case FLYPackage.FOR_EXPRESSION__DELIMETER:
        setDelimeter((ForDelimeter)null);
        return;
      case FLYPackage.FOR_EXPRESSION__BODY:
